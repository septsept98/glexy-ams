...
class TransactionDaoTest {
	...
	public void insert() throws Exception {
		...
		idInserted = transactions.getId();

		assertNotNull(transactions.getId());
	}
	
	@Test
	@Order(2)
	public void checkAll() throws Exception{
		List<Transactions> transList = transactionDao.findAll();
	...
	public void checkById() throws Exception {
		Transactions transactions = transactionDao.findById(idInserted);
